...
//Creating methods of variables assigned (using the exact names used in xml file )
@Override
protected void onCreate(Bundle savedInstanceState) {
        ...
        // The method (findViewById) points to the ID of the exact button in xml
        ...
        // OnClick listeners TO DETERMINE what happens when the button is clicked. AMG
...
*/
        // OnClick listeners TO DETERMINE what happens when the button is clicked.
...
//If statement and Switch case to handle insertion or input Values from keypad (numbers, arithmetic values etc)
...
//Creating Event listeners to handle functionality of buttons when clicked.
@Override
public void onClick(View view) {
        Button button = (Button) view;
        String data = button.getText().toString();

        //if statement to handle iteration of all the buttons.
        ...
        if(enteredInput.length() > 0){
                ...
                if (resultObject != null) {
                        ...
                        //A toast to alert the event after happening (sending a message)
...
//Adding values to memory methods (M+)
...
//Removing data or values from memory (M-)
